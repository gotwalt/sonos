...
[![Build Status](https://travis-ci.org/soffes/sonos.png?branch=master)](https://travis-ci.org/soffes/sonos) [![Code Climate](https://codeclimate.com/badge.png)](https://codeclimate.com/github/soffes/sonos)
